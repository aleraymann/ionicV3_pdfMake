...
var UserRegisterPage = /** @class */ (function () {
    ...
    UserRegisterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-user-register',template:/*ion-inline-start:"/home/aleraymann/Documentos/ionic-workspace/AgendApp_PDFMake/src/pages/user-register/user-register.html"*/'<!--\n  Generated template for the UserRegisterPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Cadastro de Usuário</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <img src="assets/imgs/agendapp.png" />\n  <ion-list>\n    <ion-item>\n      <ion-label floating>Email</ion-label>\n      <ion-input type="text" #username></ion-input>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>Senha</ion-label>\n      <ion-input type="password" #password></ion-input>\n    </ion-item>\n    <div padding>\n      <button block ion-button (click)="registrar()" item-left>Registrar</button>\n    </div>\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"/home/aleraymann/Documentos/ionic-workspace/AgendApp_PDFMake/src/pages/user-register/user-register.html"*/,
        }),
