...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_patient__ = __webpack_require__(745);
...
var EditPatientPage = /** @class */ (function () {
    function EditPatientPage(navCtrl, navParams, alertCtrl, toastCtrl, formBuilder, db) {
        ...
        this.PatientForm = this.formBuilder.group({
            name: [this.navParams.get('name'), [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(5)]],
            email: [this.navParams.get('email'), [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].email]],
            phone: [this.navParams.get('phone'), [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].minLength(11), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].maxLength(15)]],
            value_payment: [this.navParams.get('value_payment'), [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
            begin: [this.navParams.get('begin'), [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]],
